 ...
 * audio player's lyrics button brings it back.
 */
    ...
    >
      <div className="flex items-center justify-between gap-2 border-b border-paper-100 px-4 py-3">
        ...
        <button
          ...
          title="Hide lyrics"
          className="shrink-0 rounded-md p-1.5 text-paper-400 outline-none transition-colors hover:bg-paper-100 hover:text-paper-700 focus-visible:shadow-ring"
        >
          <X className="h-4 w-4" />
        </button>
      </div>
