        ...
        {!doc && (
          <div className="pointer-events-none relative z-10 flex flex-wrap items-end justify-center gap-x-10 gap-y-2 px-6 pt-6 text-center">
            {items.map((text, i) => (
              <span
                key={i}
                className="inline-block border-b-4 border-mark-blue-ink/50 pb-1.5 font-round text-4xl font-normal leading-none text-mark-blue-ink sm:text-5xl lg:text-6xl"
              >
                {text}
              </span>
            ))}
        ...
        {doc && (
          <div className="pointer-events-none absolute left-1/2 top-4 z-10 flex -translate-x-1/2 items-end gap-x-4 text-center">
            {dayDateItems.map((text, i) => (
              <span
                key={i}
                className="inline-block border-b-2 border-mark-blue-ink/50 pb-0.5 font-round text-lg font-normal leading-none text-mark-blue-ink sm:text-xl"
              >
                {text}
              </span>
            ))}
